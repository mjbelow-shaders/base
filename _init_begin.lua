...
if (shadertoy_prog_buf_a > 0) then
  buf_A = gh_render_target.create_ex_v4(winW, winH, num_color_targets, pf, linear_filtering, rt0_clamp_addressing, samples, create_depth_texture)
end
  
if (shadertoy_prog_buf_b > 0) then
  buf_B = gh_render_target.create_ex_v4(winW, winH, num_color_targets, pf, linear_filtering, rt1_clamp_addressing, samples, create_depth_texture)
end
  
if (shadertoy_prog_buf_c > 0) then
  buf_C = gh_render_target.create_ex_v4(winW, winH, num_color_targets, pf, linear_filtering, rt2_clamp_addressing, samples, create_depth_texture)
end
  
if (shadertoy_prog_buf_d > 0) then
  buf_D = gh_render_target.create_ex_v4(winW, winH, num_color_targets, pf, linear_filtering, rt3_clamp_addressing, samples, create_depth_texture)
end
  
  
img = gh_render_target.create_ex_v4(winW, winH, num_color_targets, PF_U8_RGBA, linear_filtering, img_clamp_addressing, samples, create_depth_texture)
